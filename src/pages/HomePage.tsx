...
import { BookOpen, Coffee, User, ScrollText, ArrowRightLeft, Sparkles } from 'lucide-react';
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                {/* --- FIX: Removed invalid <a> tag around <h1> --- */}
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            {/* --- FIX: Corrected this link to point to Telegram as intended --- */}
                            <a href="/about" className="flex items-center justify-center w-9 h-9 rounded-lg bg-muted hover:bg-muted/80 transition-colors" aria-label="Contact developer">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Sheet>
                            <SheetTrigger asChild>
                                <ToolCard icon={ArrowRightLeft} title="Word List Converter" variant="action" className="md:col-span-2">
                                    A handy utility to switch between list formats.
                                </ToolCard>
                            </SheetTrigger>
                            <SheetContent className="w-full sm:max-w-2xl p-0">
                                <div className="flex h-full flex-col overflow-y-scroll bg-background">
                                    <SheetHeader className="p-6 pb-4">
                                        ...
                                        <SheetDescription>
                                            Quickly convert between a vertical list and a comma-separated list.
                                        </SheetDescription>
                                    </SheetHeader>
